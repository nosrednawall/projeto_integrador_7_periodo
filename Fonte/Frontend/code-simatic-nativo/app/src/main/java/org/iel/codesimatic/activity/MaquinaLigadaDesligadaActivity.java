...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        somaLigado = dados.getFloat("somaLigado");
        somaDesligado = dados.getFloat("somaDesligado");
    ...
    private void setData() {
        ...
        PieEntry valor1 = new PieEntry(somaLigado,"Ligado %");
        PieEntry valor2 = new PieEntry(somaDesligado,"Desligado %");
